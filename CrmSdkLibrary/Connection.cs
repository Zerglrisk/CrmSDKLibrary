...
namespace CrmSdkLibrary
{
	public class Connection
	{
		...
		public class AuthHook : Microsoft.Xrm.Tooling.Connector.IOverrideAuthHookWrapper
		{
			...
			/// </summary>
			private Dictionary<string, Microsoft.IdentityModel.Clients.ActiveDirectory.AuthenticationResult> accessTokens = new Dictionary<string, Microsoft.IdentityModel.Clients.ActiveDirectory.AuthenticationResult>();
