...
namespace CrmSdkLibrary.Definition.StaticFiles
{
	...
	/// </summary>
	/// <see href="https://github.com/dotnet/aspnetcore/blob/main/src/Middleware/StaticFiles/src/FileExtensionContentTypeProvider.cs"/>
...
#else
			return path[index..]; //path.Substring(index);
#endif
		}
	}
}