        ...
        public static string GetAttributeLabel(IOrganizationService service, Entity entity, string attribute)
        {
            ...
            switch (entity[attribute].GetType().Name)
            {
                ...
                case "EntityReference":
                    ...
                    AttributeMetadata attrMetadataEntity = (AttributeMetadata)attributeResponseEntity.AttributeMetadata;
                    //Debug
                ...
                case "DateTime": //날짜 및 시간
                    ...
                    break;
                case "Boolean": //두 개 옵션
                    strLabel = ((Boolean)entity.Attributes[attribute]) ? "True" : "False";
                    break;
                case "String": //한 줄 텍스트
                    strLabel = entity[attribute].ToString();
                    break;
