...
Object.defineProperty(this, 'formContext', {
    ...
    set: function (v) {
        ...
        try {
            ...
            console.error("[new_u_js_common] Failed To Load formContext..debug.openByGuid.");
            console.error(ex);
        }
        ...
        try {
            ...
            console.error("[new_u_js_common] Failed To Load formContext..debug.openCopyForm.");
            console.error(ex);
        }
        ...
        try {
            ...
            console.error("[new_u_js_common] Failed To Load formContext..debug.getEntityTypeCode.");
            console.error(ex);
        }
        ...
        try {
            ...
            console.error("[new_u_js_common] Failed To Load formContext..OpenWebResourceDialog.");
            console.error(ex);
        }
        ...
        try {
            ...
            console.error("[new_u_js_common] Failed To Load formContext..GetEntityTypeCode.");
            console.error(ex);
        }
        try {
            ...
            console.error("[new_u_js_common] Failed To Load formContext..WebApi.SetStatus.");
            console.error(ex);
        }
        try {
        ...
        try {
            ...
            // 2021-10-20 Chris : Deprecated, Rederning Order Changed. (if want fix it, use mutationobserver that you can spying grid render time.)
            ...
            console.error("[new_u_js_common] Failed To Load formContext..SetSubGridHeaderColor.");
            console.error(ex);
        }
        try {
            ...
            console.error("[new_u_js_common] Failed To Load formContext..getDomId.");
            console.error(ex);
        }
        try {
        ...
        try {
            ...
            console.error("[new_u_js_common] Failed To Load formContext..WebApi.RetrieveGlobalOptionSets.");
            console.error(ex);
        }
        ...
        try {
            ...
            console.error("[new_u_js_common] Failed To Load formContext..WebApi.RetrieveGlobalOptionSetsAsync.");
            console.error(ex);
        }
        ...
        try {
            ...
            console.error("[new_u_js_common] Failed To Load formContext..WebApi.RetrieveEntityManyToManyRelationshipRecordsAsync.");
            console.error(ex);
        }
        try {
            ...
            console.error("[new_u_js_common] Failed To Load formContext..WebApi.RetrieveAttributeMetadataAsync.");
            console.error(ex);
        }
        try {
            ...
            console.error("[new_u_js_common] Failed To Load formContext..WebApi.RetrieveAttributeMetadataDetailAsync.");
            console.error(ex);
        }
        ...
        try {
            ...
            console.error("[new_u_js_common] Failed To Load formContext..WebApi.RetrieveEntityRelationshipMetadataAsync.");
            console.error(ex);
        }
