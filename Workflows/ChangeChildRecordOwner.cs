...
namespace CrmSdkLibrary.Workflows
{
	/// <summary>
	/// Microsoft.CrmSdk.CoreAssemblies Version v9.0.2.3 Microsoft.CrmSdk.Workflow Version 9.0.2.3
	/// </summary>
	public class ChangeChildRecordOwner : System.Activities.CodeActivity
	{
		...
		/// </summary>
		[RequiredArgument]
		[Input("ChildEntityLogicalName")]
		public InArgument<string> ChildEntityLogicalName { get; set; }
		...
		protected override void Execute(CodeActivityContext context)
		{
			...
			var childEntityLogicalNames = ChildEntityLogicalName.Get(context)?.Split(new char[] { ';' }, options: StringSplitOptions.RemoveEmptyEntries);
